...
urlpatterns = [
    ...
    url(r'^(?P<trail_id>[0-9]+)/unlike$', views.unliketrail, name='unliketrail'),
    url(r'^(?P<trail_id>[0-9]+)/uncomplete$', views.uncompletetrail, name='uncompletetrail'),
    url(r'^(?P<trail_id>[0-9]+)/unsave$', views.unsavetrail, name='unsavetrail'),
